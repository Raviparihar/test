...
public class MarketTeamActualsOnly {
	...
	//Home Dashboard page
		...
		String expectedurl = "https://gbmt-stage.neoogilvy.com/dashboard";
		  if (currenturl.equalsIgnoreCase(expectedurl))
			  ...
			  //Top 10 Spenders based on Actual Spend
	        ...
	        // if(Text.equals(MarketText))
	         {
	             ...
	             dropdown.selectByValue("100034");
	             driver.manage().timeouts().implicitlyWait(8, TimeUnit.SECONDS);
	             String Argentinaurl =  driver.getCurrentUrl();
	     	     String AregentinaExpectedurl = "https://gbmt-stage.neoogilvy.com/dashboard?market_id=100034&year=2017";
	     	     if (Argentinaurl.equalsIgnoreCase(AregentinaExpectedurl))
	       	       System.out.println("The Dashboard for Finland for the year 2017");
	...
	//Actual Spends Page
	  ...
	  WebElement LinkActualSpend = driver.findElement(By.xpath(".//*[@id='sidebar-scroll']/div/div/ul/li[2]/a/span"));
		    	...
		    	if (Add.equals("https://gbmt-stage.neoogilvy.com/actuals/add/market_id:/date:2017"))
		    	{
		    		System.out.println("You are on the Add Actual Spends Page");
		    	    driver.findElement(By.xpath(".//*[@id='main-container']/div[1]/div/div[2]/a")).click();
		    	    driver.manage().timeouts().implicitlyWait(10,TimeUnit.SECONDS);
		    	}
		    	else
		    		System.out.println("Add button has not been clicked yet");
		    	
		    	
		    	//Editing spend
		    	driver.findElement(By.xpath(".//*[@id='main-container']/div[1]/div/div[2]/a[2]")).click();
		    	String Edit = driver.getCurrentUrl();
		    	if (Edit.equals("https://gbmt-stage.neoogilvy.com/actuals/edit/date:2017"))
		    	{
		    		System.out.println("You are on the Edit Actual Spends Page");
		    	    driver.findElement(By.xpath(".//*[@id='main-container']/div[1]/div/div[2]/a/i")).click();
		    	    driver.manage().timeouts().implicitlyWait(10,TimeUnit.SECONDS);
		    	}
		    	else
		    		System.out.println("Edit button has not been clicked yet");
