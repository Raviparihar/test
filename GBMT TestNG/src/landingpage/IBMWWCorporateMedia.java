...
public class IBMWWCorporateMedia {
		  ...
		  if (currenturl.equalsIgnoreCase(expectedurl))
			...
			//Spend by Market Map based on Actual Spend 2017
			  ...
			  driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
			   ...
			   System.out.println("Spend by Market Map based on Actual Spend 2017");
			  }
			   else
			   {System.out.println("Spend by Market Map based on Actual Spend 2017");}
	        ...
	        // if(Text.equals(MarketText))
	         {
	             ...
	             dropdown.selectByValue("100094");
	             driver.manage().timeouts().implicitlyWait(8, TimeUnit.SECONDS);
	             String Argentinaurl =  driver.getCurrentUrl();
	     	     String AregentinaExpectedurl = "https://gbmt-stage.neoogilvy.com/dashboard?market_id=100094&year=2016";
		   ...
		   public void ReportsPage()
		     ...
		     int click = 0;        
		       ...
		       click ++;
		        ...
		        driver.findElement(By.xpath(".//*[@id='sidebar-scroll']/div/div/ul/li[3]/ul/li[5]/a")).click();
		        System.out.println("Projection Report Clicked");
		        driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		        click ++;
		        
		        driver.findElement(By.xpath(".//*[@id='sidebar-scroll']/div/div/ul/li[3]/ul/li[6]/a")).click();
		        System.out.println("Historical CSR Clicked");
		        driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		        click ++;
		        
		        driver.findElement(By.xpath(".//*[@id='sidebar-scroll']/div/div/ul/li[3]/ul/li[7]/a")).click();
		        System.out.println("Projection Workboook Historical Clicked");
		        driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		        click ++;
		        
		        driver.findElement(By.xpath(".//*[@id='sidebar-scroll']/div/div/ul/li[3]/ul/li[7]/a")).click();
		        System.out.println("Custom ReportsClicked");
		        driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		        click ++;
