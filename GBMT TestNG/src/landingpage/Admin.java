		   ...
		   public void ReportsPage()
		     ...
		     int click = 0;        
		       ...
		       driver.findElement(By.xpath(".//*[@id='sidebar-scroll']/div/div/ul/li[8]/ul/li[2]/a/span")).click();
		        ...
		        driver.findElement(By.xpath(".//*[@id='sidebar-scroll']/div/div/ul/li[8]/ul/li[7]/a/span")).click();
		        ...
		        driver.findElement(By.xpath(".//*[@id='sidebar-scroll']/div/div/ul/li[5]/ul/li[9]/a/span")).click();
		        ...
		        driver.findElement(By.xpath(".//*[@id='sidebar-scroll']/div/div/ul/li[8]/ul/li[11]/a/span")).click();
		        System.out.println("Custom Reports clicked");
		        driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		        click ++;
		        
		        driver.findElement(By.xpath(".//*[@id='sidebar-scroll']/div/div/ul/li[8]/ul/li[12]/a/span")).click();
		        System.out.println("US Quaterly audit clicked");
		        driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		        click ++;
		        
		        driver.findElement(By.xpath(".//*[@id='sidebar-scroll']/div/div/ul/li[8]/ul/li[13]/a/span")).click();
