...
//Reports Page
	   public void ReportsPage()
	     ...
	     int click = 0;        
	       ...
	       driver.findElement(By.xpath(".//*[@id='DataTables_Table_0_filter']/label/input")).sendKeys("Internet");
	       driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
	       click ++;
	    	
	        driver.findElement(By.xpath(".//*[@id='sidebar-scroll']/div/div/ul/li[5]/ul/li[2]/a")).click();
	        ...
	        System.out.println("Compliance cliked");
	        driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
	        click ++;
	        
	        driver.findElement(By.xpath(".//*[@id='sidebar-scroll']/div/div/ul/li[5]/ul/li[5]/a/span")).click();
	        System.out.println("Projection vs Budgets report clicked");
	        driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
	        click ++;
	         ...
	         if(true)
	           {
	            driver.findElement(By.id("email")).isEnabled();
	             if(true)
	               ...
	               driver.findElement(By.id("email")).sendKeys("manu.narang@ogilvy.com"); 
	               driver.findElement(By.id("psw")).isDisplayed();
	  	           ...
	  	           if(true)
		               ...
		               driver.findElement(By.id("psw")).sendKeys("Onearmy@16");
